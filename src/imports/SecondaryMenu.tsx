import svgPaths from "./svg-h86sohloy2";
    ...
    <div className="content-stretch flex items-center relative shrink-0">
      ...
      <div className="content-stretch flex gap-[4px] items-center justify-center p-[8px] relative shrink-0" data-name="Menu-horizontal-item">
        <div className="flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#94a3b8] text-[12px] whitespace-nowrap">
          <p className="leading-[16px]">Schedule of Investment</p>
        </div>
      </div>
    </div>
  );
...
function Title() {
  return <div className="content-stretch flex flex-[1_0_0] h-[24px] items-center min-h-px min-w-px" data-name="Title" />;
}
...
export default function SecondaryMenu() {
  return (
    <div className="bg-[#475569] content-stretch flex items-center justify-between px-[16px] py-[8px] relative size-full" data-name="secondary menu">
      <Frame />
      <Title />
